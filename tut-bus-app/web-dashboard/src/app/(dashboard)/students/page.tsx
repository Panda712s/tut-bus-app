            ...
            {filtered.map((s) => (
              <tr key={s.id}>
                ...
                <td className="px-4 py-3 text-right">
                  {s.isActive ? (
                    <button onClick={() => handleDeactivate(s.id)} className="text-xs font-medium text-red-700 dark:text-red-400 hover:underline">
                      Deactivate
                    </button>
                  ) : (
                    <button onClick={() => handleActivate(s.id)} className="text-xs font-medium text-emerald-700 dark:text-emerald-400 hover:underline">
                      Activate
                    </button>
                  )}
                </td>
